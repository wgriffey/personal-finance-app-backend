...
from .views import UserViewSet, PlaidLinkToken, PublicTokenExchange, InstitutionDetailsDB, AccountListPlaid, AccountListDB, AccountDetailsDB, TransactionListPlaid, TransactionListDB, InvestmentListPlaid, InvestmentListDB
...
urlpatterns = [
    ...
    path('api/get_institution_by_account_id/<int:account_id>', InstitutionDetailsDB.as_view()),
